...
@objcMembers public class DocumentCaptureSession: CameraCaptureSession {
    ...
    public class func getDocumentCaptureSession(delegate: DocumentCaptureSessionDelegate?,
        ...
        return captureSession.getDocumentCaptureSessionInstance(delegate: delegate!,
                                                                frameDelegate: frameDelegate,
                                                                autoCaptureDelegate: autoCaptureDelegate,
                                                                captureDevice: captureDevice)
    }
    // LAWRENCESPRING
    private func getDocumentCaptureSessionInstance(delegate: DocumentCaptureSessionDelegate?,
                                                   frameDelegate: FrameAnalysisDelegate,
                                                   autoCaptureDelegate: AutoCaptureDelegate,
                                                   captureDevice: AVCaptureDevice) -> DocumentCaptureSession {
    ...
    // { LAWRENCESPRING } LEAVE THIS TO BE ABLE TO RESTART WITH NO CONSEQUENCES
